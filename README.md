...
> **공개 준비 중입니다.** 코드 생성 도구와 명세를 먼저 공개합니다. 정식 서비스 안내는 준비 중이며, 곧 찾아뵙겠습니다.
...
최신 고객용 설치파일은 [GitHub Release v0.2.3](https://github.com/meritz-securities/open-api-codegen-mcp/releases/tag/v0.2.3)에서 받으십시오.
...
| Claude Code·Codex·Gemini·Cursor·VS Code | [OS별 실행파일](https://github.com/meritz-securities/open-api-codegen-mcp/releases/tag/v0.2.3) |
...
릴리스는 태그를 밀면 GitHub Actions가 세 플랫폼을 빌드해 올립니다: `git tag v0.2.3 && git push origin v0.2.3`.
